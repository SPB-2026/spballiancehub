...
async function create(input) {
  ...
  const body = cleanRichText(input.body || '', { field: 'Message', max: 500, optional: true });
...
async function update(id, input) {
  ...
  if (input.body !== undefined) fields.body = cleanRichText(input.body, { field: 'Message', max: 500, optional: true });
